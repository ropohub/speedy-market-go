...
const Categories: React.FC = () => {
  ...
  const spotlightItems = [
    { id: 'house-brands', name: 'Sale is Live!', image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=150&h=150&fit=crop', type: 'sale' },
    { id: 'spring-summer', name: 'Spring Summer', image: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=150&h=150&fit=crop', type: 'season' },
    { id: 'top-trends', name: 'Top Trends Her!', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=150&h=150&fit=crop', type: 'trends' },
  ];

  const trendsInFocus = [
    { id: 'tiered-dresses', name: '#Tiered Dresses', image: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=150&h=150&fit=crop' },
    { id: 'high-top-shoes', name: '#High Top shoes', image: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=150&h=150&fit=crop' },
    { id: 'vneck-kurtas', name: '#Vneck-Kurtas', image: 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=150&h=150&fit=crop' },
    { id: 'textured', name: '#Textured', image: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=150&h=150&fit=crop' },
    { id: 'baguette', name: '#Baguette', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=150&h=150&fit=crop' },
    { id: 'cargo-style', name: '#Cargo style', image: 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=150&h=150&fit=crop' },
  ];
            ...
            <div className="flex-1 overflow-x-hidden">
              ...
              <div className="bg-white/30 backdrop-blur-sm rounded-t-3xl mx-4 shadow-sm border border-white/20">
                ...
                <div className="px-4 py-6">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">In the Spotlight</h3>
                  <div className="flex gap-4 overflow-x-auto pb-2">
                    {spotlightItems.map((item) => (
                      ...
                      >
                        <div className="w-20 h-20 rounded-full overflow-hidden mb-2 bg-white/60 backdrop-blur-sm shadow-sm">
                          <img
                            src={item.image}
                            alt={item.name}
                ...
                <div className="px-4 py-6">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">Trends in focus</h3>
